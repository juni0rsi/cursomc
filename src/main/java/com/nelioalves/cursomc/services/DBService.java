...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		cat7.getProdutos().addAll(Arrays.asList(p1));
		...
		Cliente cli2 = new Cliente(null, "Ana Silva", "juniorsi@gmail.com", "34734505888", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("997293839"));
